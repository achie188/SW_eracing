...
with tab1:
    ...
    with tab11:
        ...
        with col2:
            ...
            with st.expander("THE POINTS SYSTEM EXPLAINED"):
                st.markdown('''
                            ...
                            ''')
            with st.expander("Category 1: Finishing Position Points"):
                st.markdown('''                
                            ##### Category 1: Finishing Position Points
            ...
            with st.expander("Category 3: Intermediate Sprint Points"):
                st.markdown('''                             
                            ...
                            ''')
            with st.expander("Most Aggressive Rider"):
                st.markdown('''                              
